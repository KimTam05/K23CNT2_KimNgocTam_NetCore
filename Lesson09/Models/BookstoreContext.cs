...
public partial class BookstoreContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Server=DESKTOP-RO46BHR\\SQLEXPRESS;Database=Bookstore;Integrated Security=True;TrustServerCertificate=True;MultipleActiveResultSets=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            entity.HasKey(e => e.AccountId).HasName("PK__Account__349DA5A6B702F394");
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Book__3DE0C20775AB6B9E");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__19093A0B9EF3CAF5");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__OrderBoo__C3905BCF61BD628A");
        ...
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__D3B9D36C7DF48F3E");
        ...
        {
            entity.HasKey(e => e.PublisherId).HasName("PK__Publishe__4C657FAB2FB4091F");
